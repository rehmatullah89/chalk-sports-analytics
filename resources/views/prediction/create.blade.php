...
<div class="container-fluid">
    <div class="justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header">Custom NFL Predictive Model
            ...
            <div class="card-body predictions">
                {!! Form::open(array('route' => 'prediction.store', 'method'=>'POST')) !!}
                ...
                <div class="row mb-4">
                    <div class="col-6">
                        <div class="form-group ">
                            ...
                            <select name="away_team_id" id="away_team_id" class='form-select drop-down vodiapicker teams' required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" id="user_id" class='form-select drop-down vodiapicker user' required>
                                @foreach($users as $userId => $userName)
                                    <option value="{{$userId}}" {{$userId == 0?'selected':''}}>{{$userName}}</option>
                                @endforeach
                            </select>
                ...
                <div class="row mb-4">
                    <div class="col-8">
                        <div style="margin-top: 5px;">
                            <button style="border-radius: 20px;" type="submit" class="btn btn-outline-primary btn-sm">Submit</button>
                            <a style="border-radius: 20px;" class="btn btn-outline-primary btn-sm" href="/games/{{auth()->user()->id}}/edit">Adjust Ratings</a>
                        </div>
                    </div>
                </div>
...
//***********************start here************//
                ...
                $('#select_week_id').html(weekArray[0]);
...
//*************end here*************
        if(getCookie('home_team_id') != ''){
            ...
            $('#select_week_id').html(weekArray[getCookie('pre_week_number')-1]);
