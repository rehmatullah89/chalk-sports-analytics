...
<script src='https://cdn.plot.ly/plotly-2.16.1.min.js'></script>
        ...
        @endif
        <div class="card11">
            <div class="card-header-web">NFL Picks Leaderboard
                <span class="float-right">
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('/') }}"><strong>Home</strong></a>
                        <a class="btn btn-outline-primary btn-sm" href="{{ url('/nfl-picks') }}"><strong>Your NFL Picks</strong></a>
                </span>
             </div>

            <div class="card-body guage-holder">
                <div class="row">
