...
<div class="container-fluid">
    <div class="justify-content-center">
        ...
        @endif
            ...
            @endif
        <div class="card">
            <div class="card-header">Matchup Breakdown
                <div  class="float-right">
                    <span style="font-size: 12px;"><i class="fa fa-lock" aria-hidden="true"></i> Locked Items</span>
                    @hasrole('admin')
                        <a class="btn btn-outline-primary btn-sm" href="{{ route('games.index') }}"><strong>NFL Schedules</strong></a>
                    @else
                ...
                <div class="card-body viewGamePage">
                    ...
                    @if(!$show)
                        <table class="table table-hover" id="dataTable">
                            <tbody>
                            <tr>
                                <td><div class="message-table">Please Buy Package to View Full Game Details.</div></td>
                            </tr>
                            </tbody>
                        </table>
                    @endif
                            ...
                            <table class="table table-hover view-game-table" id="dataTable">
                                ...
                                @foreach($injuries as $injury)
                                    @if($data->team_1_id == $injury->team_id && $count1 < 5)
                                        ...
                                        <tr>
                                            <td>{{$injury->player_name}}</td>
                                            <td class="col-width" style="text-align: left;">
                                            <div class="{{ in_array($injury->status, ['Out', 'Injured Reserve'])?'red-box':'yellow-box' }}"></div>
                                            {{$injury->status}}</td>
                                        </tr>
                                    @endif
                                @endforeach
